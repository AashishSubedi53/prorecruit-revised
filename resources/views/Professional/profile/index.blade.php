...
<section class="flex space-x-10 p-10 justify-center">
  <div id="left" class="bg-gray-200 p-10 rounded-md w-1/3">
    ...
    <div class="mt-5">
      <a href="{{route('professional.my-profile.edit', auth()->user()->id)}}" class="bg-red-500 text-white py-2 px-4 rounded-lg">
        Edit Details
      </a>
    </div>

    <div id="professional-info" class="flex mt-5 space-x-20">

      <div class="space-y-5">
        <div>
          <label for="first_name" class="text-gray-500 text-xl font-semibold">First Name</label>
          <p id="first_name" class="font-semibold">{{auth()->user()->professional->first_name}}</p>
        </div>
        ...
        <div>
          ...
          <p id="phonenumber" class="font-semibold">{{auth()->user()->professional->phonenumber}}</p>    
        </div>  
      ...
      <div class="space-y-5">
        <div>
          ...
          <p id="last_name" class="font-semibold">{{auth()->user()->professional->last_name}}</p>
        </div>
  ...
  <div id="right" class="bg-gray-200 p-10 rounded-md w-1/3">
