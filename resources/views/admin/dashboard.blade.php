<x-app-layout>
    ...
    <div x-data="stats" x-init="getData">
        <div id="data" class="flex flex-col sm:flex-row md:flex-row gap-x-1 bg-white justify-between md:overflow-auto mb-10">
            <div id="users" class="flex flex-row gap-x-1 border border-gray-200 bg-white-900 py-5 px-8 text-center">
                                ...
                                <td class="px-6 py-4">
                                    <div class="h-16 w-16">
                                        @if ($user->user_type === 'customer' && $user->customer)
                                            <img src="{{asset('storage/' . $user->customer->profile_image)}}" alt="image" class="h-full w-full">
                                        @elseif ($user->user_type === 'professional' && $user->professional)
                                            <img src="{{asset('storage/' . $user->professional->profile_image)}}" alt="image" class="h-full w-full">
                                        @else
                                            <img src="{{asset('build/assets/images/default-profile.png')}}" alt="image">
                                        @endif
                                    </div>
                                </td>
                                <td class="px-6 py-4">
