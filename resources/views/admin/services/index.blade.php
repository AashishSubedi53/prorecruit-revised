<x-app-layout>
   ...
   <!-- table --> 
<div class="mt-5 mb-5">
  <a href="{{route('admin.services.create')}}" class="text-white bg-blue-500 p-3 rounded ">Add Services</a>
</div>
    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="px-6 py-4">
                    <div class="h-20 w-20">
                        <img src="{{asset('storage/' . $service->image)}}" alt="service image" class="h-20 w-20">
                    </div>
                </td>
                <td class="px-6 py-4">
                ...
                <td>
                  <div class="flex flex-row gap-1 p-2">                    
                    <a href="{{route('admin.services.edit', $service->id)}}" class="text-white bg-blue-950 rounded px-4 p-2">Edit</a>
