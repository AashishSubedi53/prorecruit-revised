<x-app-layout>
  ...
  <div class="mt-5 mb-5">
    <a href="{{route('admin.services.index')}}" class="bg-rose-700 text-white py-2 px-4 rounded-md">Go Back</a>
  </div>
  ...
  @if($message = Session::get('success'))
    ...
    <form class="max-w-lg mb-5" action="{{route('admin.services.update', $service->id)}}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PATCH')
      <div class="mb-5">
