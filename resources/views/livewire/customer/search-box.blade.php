<div>
    <form class="max-w-md mx-auto mb-5 mt-10" wire:submit="redirectTo" id="Searchform">   
        ...
        <p class="text-white py-2 px-1 font-serif">Example: Try searching for "plumber"</p>
    </form>
</div>
